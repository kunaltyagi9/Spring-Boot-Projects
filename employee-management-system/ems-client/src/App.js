...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route>
      <Route>
        <Route path={routes.main.path} element={<Navigate to={`${routes.main.path}${routes.allemployees.path}`} />} />
        ...
        <Route path={routes.invalid.path} element={<Navigate to={`${routes.main.path}${routes.allemployees.path}`} />} />
      </Route>
    </Route>
  )
)
